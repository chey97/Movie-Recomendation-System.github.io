...
<div class="col-sm-12 text-center">
    ...
    if( isset( $_GET['ls'] ) ) {
        ...
        if ($login_status == 1) {
            echo "<p style='color: white' class='lead'>You are logged in as <span class='text-success text-uppercase'>", $_SESSION['login'], "</span></p>";
        ...
        echo "<p class='lead'>You are not logged in. Please login or <a href='#'>create</a> a new account</p>";
    }

    if ( $login_status != 1 && $login_status != 3 )

        header( "Refresh:3; url=loginpage.php", true, 303);
     ?>
